<div class="box">
	...
	?>
        ...
        <div class="box-content">
        	...
        	<div class="noidung">
        		<div class="nd_left">
        			<img src="public/frontend/upload/cho_thue_xe/<?php echo $row["anh"];?>">
        		</div>
        		<div class="nd_center" style="width: 400px;">
        			<div class="row"><?php echo $row["noi_dung"];?></div>
        			<div class="row gia">Giá từ: <span><?php echo number_format($row["gia"]);?> VNĐ</span></div>
        			<a href="#tab3" class="button" id="chucnang" style="margin-top: 10px;">Đặt xe</a>
        		</div>
        	</div>
            <!-- end noidung -->
        	<div class="lichtrinh">
