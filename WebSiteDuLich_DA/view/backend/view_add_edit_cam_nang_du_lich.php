<div class="col-md-10 col-xs-offset-1" style="width: 1020px; margin-top: 40px; margin-left: -9px;">
	<div class="panel panel-primary">
		<div class="panel-heading">Thêm, sửa cẩm nang du lịch</div>
		<div class="panel-body">
			<form enctype="multipart/form-data" method="post" action="<?php echo $form_action; ?>">
				...
				<?php
					...
					$anh = $this->model->fetch("select anh from cam_nang_du_lich where pk_id='$id'");
				?>
				<div class="row" style="margin-top: 5px;">
					<div class="col-md-3">Ảnh đã chọn</div>
					<div class="col-md-9">
						<img src="public/frontend/upload/cam_nang_du_lich/<?php echo $anh[0]["anh"];?>" style="width: 100px;">
					</div>
				</div>
				<!-- end row -->
				<!-- row -->
