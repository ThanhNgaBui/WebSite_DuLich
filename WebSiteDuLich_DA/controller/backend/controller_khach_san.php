<?php 
	class controller_khach_san extends controller{
		public function __construct(){
			...
			switch($act){
				case "delete":
					...
					$this->model->execute("delete from khach_san where pk_id=$id");
			...
			$arr = $this->model->fetch("select * from khach_san order by pk_id desc limit $tu_ban_ghi,$so_ban_ghi_tren_1_trang");
			//load view
			include "view/backend/view_khach_san.php";
			//------------
		}
	}
	new controller_khach_san();
 ?>